...
export const SITE = {
  ...
  summary: "A one-line summary of your business for search engines and LLMs.",

  /** Longer LocalBusiness description (sitewide JSON-LD node). */
  localBusinessDescription:
    "A longer description of your business and the areas you serve.",
  ...
  integrations: {
    ...
    gtmId: "",
    /** MailerLite Universal account id. Empty = MailerLite off. */
    mailerLiteAccount: "",
    /** Usercentrics CMP settings id. Empty = the cookie banner is off. */
    usercentricsId: "",
